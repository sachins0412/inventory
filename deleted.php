...
$subcat=$_POST['subcat'];	
$catid=$_POST['cat'];
$sql="DELETE FROM subcategory WHERE name='$subcat' AND catid='$catid' AND user='$user' ";
$result=mysqli_query($conn,$sql);
$sql1="SELECT name FROM category WHERE catid='$catid'";
$result1=mysqli_query($conn,$sql1);
$sql2="SELECT quantity FROM subcategory WHERE catid='$catid' AND name='$subcat' AND user='$user'";
$result2=mysqli_query($conn,$sql2);
$sql3="SELECT unitcost FROM stockin WHERE catid='$catid' AND subcat='$subcat' AND user='$user'";
